...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      >
        <svg
          className="shrink-0 w-5 h-5 mr-2 text-gray-300 transition group-hover:text-gray-300"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
        >
      ...
      <div>
        ...
        <div className="mb-4">
          <Link
            className="flex items-center py-2 pl-12 pr-4 transition cursor-pointer hover:bg-gray-800 hover:text-gray-200"
            href="#"
          >
            Shopify
          </Link>
      ...
      >
        ...
        <div className="ml-0 transition md:ml-60">
          ...
          <div className="mt-2 p-4">
            ...
            <div className="-mt-2 border-4 border-dashed rounded h-fit">
              {children}
            </div>
          </div>
        </div>
